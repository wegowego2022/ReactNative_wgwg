        ...
        <View style={styles.separator} />
          ...
          <View style={styles.relatedContents}>
            ...
            <View style={styles.relatedContainer} >
              <View>
                  <Image style={styles.relatedImage} source={item.info1.subimage}/>
              </View>
              <View style={styles.relatedTextCon}>
                  <Text style={styles.relatedTitle}>{item.info1.type}</Text>
                  <Text style={styles.relatedEpisode}>{item.info1.episode}</Text>
              </View>
              <View>
